...
python scripts\multiorg\multiorg_sam2.py --weights output\checkpoint_best_regular.pth --model-variant small --src D:\datasets\mutliorg\MultiOrg_v2\test --dst results\multiorg_sam2_finetuned --windows 512 --overlap 0.3 --conf 0.25 --score-filter 0.3 --sam2-checkpoint runs\sam2_finetune\sam2_finetuned.pt --max-images 5 --save-vis
